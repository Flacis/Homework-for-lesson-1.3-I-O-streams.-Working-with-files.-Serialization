...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String firstSave = "E:\\Games\\savegames\\save1.dat";
        String twoSave = "E:\\Games\\savegames\\save2.dat";
        String threeSave = "E:\\Games\\savegames\\save3.dat";

        saveGame(save1, save2, save3, firstSave, twoSave, threeSave);
        zipFiles(firstSave, twoSave, threeSave);
    ...
    private static void zipFiles(String firstSave, String twoSave, String threeSave) {
        try (ZipOutputStream zout1 = new ZipOutputStream(new FileOutputStream("E:\\Games\\savegames\\zip1.zip"));
             ZipOutputStream zout2 = new ZipOutputStream(new FileOutputStream("E:\\Games\\savegames\\zip2.zip"));
             ZipOutputStream zout3 = new ZipOutputStream(new FileOutputStream("E:\\Games\\savegames\\zip3.zip"));
